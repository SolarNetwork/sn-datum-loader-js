// https://github.com/SolarNetwork/sn-datum-loader-js Version 0.8.4-dev.0. Copyright 2019 Matt Magoffin.
   ...
   */
		...
		value: function loadData(page) {
			...
			var req = jsonClient(url).on("beforesend", function (request) {
				...
				_this2.handleResults(new Error("Error requesting data for " + url + ": " + error));
			});
