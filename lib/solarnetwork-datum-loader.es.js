// https://github.com/SolarNetwork/sn-datum-loader-js Version 0.10.2-dev.0. Copyright 2019 SolarNetwork Foundation.
import { queue } from 'd3-queue';
import { NodeDatumUrlHelper, HttpHeaders, Logger, DatumFilter, Pagination, DatumReadingTypes, urlQuery } from 'solarnetwork-api-core';
  ...
  _createClass(DatumLoader, [{
    ...
    value: function loadData(page) {
      ...
      var req = jsonClient(reqUrl).on("beforesend", function (request) {
        ...
        var totalResults = json.data ? json.data.totalResults : null;
...
export { DatumLoader, DatumRangeFinder, DatumSourceFinder, MultiLoader };
