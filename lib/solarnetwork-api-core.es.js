// https://github.com/SolarNetwork/sn-datum-loader-js Version 0.10.7-dev.0. Copyright 2024 SolarNetwork Foundation.
import { HttpHeaders, Urls } from 'solarnetwork-api-core/lib/net/index.js';
import { Logger } from 'solarnetwork-api-core/lib/util/index.js';
import { queue } from 'd3-queue';
import { Pagination, DatumFilter, DatumReadingTypes } from 'solarnetwork-api-core/lib/domain/index.js';
...
class DatumLoader extends JsonClientSupport {
    ...
    fetch() {
        if (this.#incrementalMode) {
            throw new Error("Incremental mode is not supported via fetch(), use load(callback) instead.");
        }
