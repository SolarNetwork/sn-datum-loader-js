// https://github.com/SolarNetwork/sn-datum-loader-js Version 0.4.1-dev.0. Copyright 2017 Matt Magoffin.
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-request'), require('d3-queue'), require('solarnetwork-api-core')) :
	typeof define === 'function' && define.amd ? define(['exports', 'd3-request', 'd3-queue', 'solarnetwork-api-core'], factory) :
	(factory((global.sn = global.sn || {}),global.d3,global.d3,global.sn));
}(this, (function (exports,d3Request,d3Queue,solarnetworkApiCore) { 'use strict';
...
var DatumRangeFinder = function () {
    ...
    *                                               then only public data can be queried
    ...
    function DatumRangeFinder(urlHelpers, authBuilder) {
        ...
        this._helpers = Array.isArray(urlHelpers) ? urlHelpers : urlHelpers ? [urlHelpers] : [new solarnetworkApiCore.NodeDatumUrlHelper()];
...
var DatumLoader = function () {
  ...
  */
    ...
    */
		...
		/** @type {NodeDatumUrlHelper} */
		this.urlHelper = urlHelper || new solarnetworkApiCore.NodeDatumUrlHelper();

		/** @type {DatumFilter} */
		this.filter = filter || new solarnetworkApiCore.DatumFilter({ nodeIds: this.urlHelper.nodeIds });
